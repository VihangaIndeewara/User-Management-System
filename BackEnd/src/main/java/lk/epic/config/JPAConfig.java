...
@EnableJpaRepositories(basePackages = "lk.epic.repo")
public class JPAConfig {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory(DataSource ds, JpaVendorAdapter jpa){
        ...
        bean.setPackagesToScan("lk.epic.entity");
    ...
    public DataSource dataSource(){
        ...
        ds.setUrl("jdbc:mysql://localhost:3306/user_management_system?createDatabaseIfNotExits=true");
        ds.setUsername("root");
        ds.setPassword("1234");
        return ds;
